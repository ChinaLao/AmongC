...
var grammar = {
    ...
    {"name": "choice_choice_choice", "symbols": ["iterate_choice"]},
    {"name": "choice_choice_choice", "symbols": []},
    {"name": "choice", "symbols": ["struct_new", "choice_choice_choice"]},
    {"name": "choice", "symbols": ["function_call_statement_choice", "choice_choice_choice"]},
    {"name": "choice", "symbols": ["iterate_choice"]},
    ...
    {"name": "variable_choice", "symbols": ["notter", "negation", (lexer.has("open_paren") ? {type: "open_paren"} : open_paren), "variable_choice_choice"]},
    {"name": "variable_choice_choice", "symbols": ["condition", (lexer.has("close_paren") ? {type: "close_paren"} : close_paren), "oper_condition"]},
    {"name": "variable_choice_choice", "symbols": ["compute_choice", (lexer.has("close_paren") ? {type: "close_paren"} : close_paren), "oper_compute"]},
    ...
    {"name": "condition", "symbols": ["conditional"]},
    {"name": "condition", "symbols": ["notter", (lexer.has("open_paren") ? {type: "open_paren"} : open_paren), "condition", (lexer.has("close_paren") ? {type: "close_paren"} : close_paren), "oper_condition"]},
    ...
    {"name": "condition_less", "symbols": ["condition_choice_less", "oper_condition"]},
    {"name": "condition_less", "symbols": ["notter", (lexer.has("open_paren") ? {type: "open_paren"} : open_paren), "condition", (lexer.has("close_paren") ? {type: "close_paren"} : close_paren), "oper_condition"]},
