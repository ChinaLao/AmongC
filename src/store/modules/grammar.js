...
var grammar = {
    ...
    {"name": "statement_choice", "symbols": ["unary", (lexer.has("id") ? {type: "id"} : id)]},
    ...
    {"name": "condition", "symbols": [(lexer.has("not") ? {type: "not"} : not), (lexer.has("open_paren") ? {type: "open_paren"} : open_paren), "condition_choice", "additional_condition", (lexer.has("close_paren") ? {type: "close_paren"} : close_paren), "recur_condition"]},
