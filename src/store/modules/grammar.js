...
var grammar = {
    ...
    {"name": "variable_choice", "symbols": [(lexer.has("id") ? {type: "id"} : id), "variable_array", "string_access"]},
    ...
    {"name": "condition_notter", "symbols": ["negation", (lexer.has("id") ? {type: "id"} : id), "string_access"]},
