...
var grammar = {
    ...
    {"name": "recur_assign", "symbols": [(lexer.has("equal") ? {type: "equal"} : equal), (lexer.has("id") ? {type: "id"} : id), "iterate_id", "recur_assign"]},
    {"name": "recur_assign", "symbols": []},
    {"name": "recur_assign_choice", "symbols": ["struct_new", "iterate_first_choice", "choice_choice"]},
    {"name": "recur_assign_choice", "symbols": ["function_call_statement_choice", "iterate_first_choice", "choice_choice"]},
    {"name": "recur_assign_choice", "symbols": ["iterate_choice", "choice_choice"]},
    {"name": "recur_assign_choice", "symbols": ["first_compute_choice"]},
    {"name": "recur_assign_choice", "symbols": ["first_condition_choice"]},
    {"name": "assign_choice_choice", "symbols": ["recur_assign_choice"]},
    {"name": "assign_choice_choice", "symbols": ["recur_assign", "recur_choice_choice"]},
    {"name": "recur_choice", "symbols": [(lexer.has("id") ? {type: "id"} : id), "assign_choice_choice"]},
    {"name": "recur_choice", "symbols": ["condition_notter_less", "oper_condition"]},
    {"name": "recur_choice", "symbols": ["not_many", "not_choice"]},
    {"name": "recur_choice", "symbols": [(lexer.has("negative") ? {type: "negative"} : negative), "negative_choice"]},
