...
var grammar = {
    ...
    {"name": "string_access", "symbols": [(lexer.has("access") ? {type: "access"} : access), (lexer.has("open_paren") ? {type: "open_paren"} : open_paren), "array_size", (lexer.has("close_paren") ? {type: "close_paren"} : close_paren)]},
    ...
    {"name": "digit_notter", "symbols": ["negation", (lexer.has("id") ? {type: "id"} : id), "id_array", "string_access"]},
    {"name": "digit_notter", "symbols": ["function_call_statement", "string_access"]},
    {"name": "digit_notter", "symbols": ["struct_statement", "string_access"]},
    ...
    {"name": "switch_choice", "symbols": [(lexer.has("str_literal") ? {type: "str_literal"} : str_literal), (lexer.has("access") ? {type: "access"} : access), (lexer.has("open_paren") ? {type: "open_paren"} : open_paren), "array_size", (lexer.has("close_paren") ? {type: "close_paren"} : close_paren)]},
    ...
    {"name": "element_option", "symbols": [(lexer.has("open_bracket") ? {type: "open_bracket"} : open_bracket), "array_size", "string_access", (lexer.has("close_bracket") ? {type: "close_bracket"} : close_bracket)]},
