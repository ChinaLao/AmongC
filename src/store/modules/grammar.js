...
var grammar = {
    ...
    {"name": "choice", "symbols": []},
    {"name": "variable_next", "symbols": ["compute_choice", (lexer.has("close_paren") ? {type: "close_paren"} : close_paren), "oper_compute"]},
    {"name": "variable_next", "symbols": ["condition", (lexer.has("close_paren") ? {type: "close_paren"} : close_paren), "oper_condition"]},
    ...
    {"name": "variable_choice", "symbols": [(lexer.has("open_paren") ? {type: "open_paren"} : open_paren), "variable_next"]},
    ...
    {"name": "first_compute_choice", "symbols": [(lexer.has("arith_oper") ? {type: "arith_oper"} : arith_oper), "compute_choice"]},
