...
var grammar = {
    ...
    {"name": "global", "symbols": [(lexer.has("singleComment") ? {type: "singleComment"} : singleComment), "global"]},
    {"name": "global", "symbols": []},
    ...
    {"name": "array_define_first", "symbols": [(lexer.has("open_bracket") ? {type: "open_bracket"} : open_bracket), "struct_size", (lexer.has("close_bracket") ? {type: "close_bracket"} : close_bracket), "string_access", "array_define_second"]},
    ...
    {"name": "main_statement", "symbols": [(lexer.has("singleComment") ? {type: "singleComment"} : singleComment), "main_statement"]},
    ...
    {"name": "for_notter", "symbols": ["negation", (lexer.has("id") ? {type: "id"} : id), "digit_another_choice", "string_access"]},
