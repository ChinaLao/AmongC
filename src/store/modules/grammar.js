...
var grammar = {
    ...
    {"name": "negative_many", "symbols": [(lexer.has("negative") ? {type: "negative"} : negative), "negative_again"]},
    {"name": "negative_again", "symbols": [(lexer.has("negative") ? {type: "negative"} : negative), "negative_again"]},
    {"name": "negative_again", "symbols": []},
    ...
    {"name": "function_statement_choice", "symbols": ["loop_statement"]},
    {"name": "function_statement_choice", "symbols": ["if_statement"]},
    {"name": "function_statement_choice", "symbols": ["switch_statement"]},
    {"name": "function_statement_choice", "symbols": [(lexer.has("id") ? {type: "id"} : id), "id_start_statement"]},
    {"name": "function_statement_choice", "symbols": [(lexer.has("unary_oper") ? {type: "unary_oper"} : unary_oper), (lexer.has("id") ? {type: "id"} : id), (lexer.has("terminator") ? {type: "terminator"} : terminator)]},
    ...
    {"name": "vote", "symbols": []},
    {"name": "return_next_choice", "symbols": ["new_choice", (lexer.has("close_paren") ? {type: "close_paren"} : close_paren), "variable_next_null"]},
