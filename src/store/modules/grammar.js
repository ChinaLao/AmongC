...
var grammar = {
    ...
    {"name": "recur_choice", "symbols": [(lexer.has("open_paren") ? {type: "open_paren"} : open_paren), "choice", (lexer.has("close_paren") ? {type: "close_paren"} : close_paren), "variable_next_null"]},
    ...
    {"name": "variable_recur_assign", "symbols": [(lexer.has("equal") ? {type: "equal"} : equal), (lexer.has("id") ? {type: "id"} : id), "variable_recur_assign"]},
    ...
    {"name": "recur_variable_choice", "symbols": [(lexer.has("open_paren") ? {type: "open_paren"} : open_paren), "choice", (lexer.has("close_paren") ? {type: "close_paren"} : close_paren), "variable_next_null"]},
    ...
    {"name": "recur_variable", "symbols": [(lexer.has("equal") ? {type: "equal"} : equal), (lexer.has("id") ? {type: "id"} : id), "recur_variable"]},
