...
var grammar = {
    ...
    {"name": "choice", "symbols": ["struct_statement"]},
    {"name": "choice", "symbols": ["function_call_statement"]},
    {"name": "choice", "symbols": ["first_compute_choice"]},
    {"name": "choice", "symbols": ["first_condition_choice"]},
    {"name": "choice", "symbols": []},
    {"name": "variable_choice", "symbols": ["literal"]},
    {"name": "variable_choice", "symbols": [(lexer.has("id") ? {type: "id"} : id), "choice", "string_access"]},
    ...
    {"name": "iterate_statement_condition_less", "symbols": ["unary", "unary_choice", "iterate_statement_extra"]},
    ...
    {"name": "digit_choice_less", "symbols": ["notter", "digit_notter"]},
    {"name": "digit_notter_less", "symbols": [(lexer.has("int_literal") ? {type: "int_literal"} : int_literal)]},
    ...
    {"name": "condition_choice_less", "symbols": ["notter", "condition_notter"]},
    {"name": "condition_notter_less", "symbols": ["literal"]},
    {"name": "condition_notter_less", "symbols": ["iterate_statement_condition"]},
    {"name": "condition_notter_less", "symbols": ["compute_choice_less"]},
    ...
    {"name": "condition_less", "symbols": ["condition_extra_less", "oper_choice", "condition", "recur_condition"]},
    ...
    {"name": "condition_less", "symbols": ["condition_extra_less"]},
    ...
    {"name": "for_notter_choice", "symbols": ["function_call_statement_choice"]},
    {"name": "for_notter_choice", "symbols": ["struct_statement_choice"]},
    {"name": "for_notter", "symbols": ["literal"]},
    {"name": "for_notter", "symbols": ["negation", (lexer.has("id") ? {type: "id"} : id), "for_notter_choice", "string_access"]},
    ...
    {"name": "iterate_choice_choice", "symbols": ["function_call_statement_choice"]},
    {"name": "iterate_choice_choice", "symbols": ["struct_statement_choice"]},
    ...
    {"name": "iterate_choice", "symbols": [(lexer.has("id") ? {type: "id"} : id), "iterate_choice_choice"]},
    {"name": "unary_choice_choice", "symbols": ["struct_statement_choice"]},
    {"name": "unary_choice_choice", "symbols": []},
    ...
    {"name": "switch_notter_choice", "symbols": ["function_call_statement_choice"]},
    {"name": "switch_notter_choice", "symbols": ["struct_statement_choice"]},
    {"name": "switch_notter", "symbols": [(lexer.has("id") ? {type: "id"} : id), "switch_notter_choice", "string_access"]},
