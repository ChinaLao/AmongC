...
var grammar = {
    ...
    {"name": "recur_assign", "symbols": [(lexer.has("equal") ? {type: "equal"} : equal), (lexer.has("id") ? {type: "id"} : id), "struct_choice", "recur_assign"]},
    ...
    {"name": "assign_choice", "symbols": ["struct_choice", "string_access", (lexer.has("equal") ? {type: "equal"} : equal), "recur_choice"]},
    ...
    {"name": "variable_repeat", "symbols": [(lexer.has("id") ? {type: "id"} : id), "recur_id_choices"]},
    {"name": "variable_repeat", "symbols": ["condition_notter_less", "oper_condition"]},
    {"name": "variable_repeat", "symbols": ["not_many", "not_choice"]},
    {"name": "variable_repeat", "symbols": [(lexer.has("negative") ? {type: "negative"} : negative), "negative_choice"]},
    {"name": "variable_repeat", "symbols": [(lexer.has("open_paren") ? {type: "open_paren"} : open_paren), "variable_choice", (lexer.has("close_paren") ? {type: "close_paren"} : close_paren), "variable_next_null"]},
    {"name": "variable_recur_assign", "symbols": [(lexer.has("equal") ? {type: "equal"} : equal), "recur_variable_choice"]},
    {"name": "variable_recur_assign", "symbols": ["recur_variable_assign"]},
    {"name": "variable_recur_assign", "symbols": []},
    {"name": "recur_variable_assign", "symbols": ["struct_new", "iterate_first_choice", "choice_choice"]},
    {"name": "recur_variable_assign", "symbols": ["function_call_statement_choice", "iterate_first_choice", "choice_choice"]},
    {"name": "recur_variable_assign", "symbols": ["iterate_choice", "choice_choice"]},
    {"name": "recur_variable_assign", "symbols": ["first_compute_choice"]},
    {"name": "recur_variable_assign", "symbols": ["first_condition_choice"]},
    {"name": "recur_id_choices", "symbols": ["recur_variable_assign"]},
    {"name": "recur_id_choices", "symbols": ["variable_recur_assign", "recur_variable"]},
    {"name": "recur_variable_choice", "symbols": [(lexer.has("id") ? {type: "id"} : id), "recur_id_choices"]},
    {"name": "recur_variable_choice", "symbols": ["condition_notter_less", "oper_condition"]},
    {"name": "recur_variable_choice", "symbols": ["not_many", "not_choice"]},
    {"name": "recur_variable_choice", "symbols": [(lexer.has("negative") ? {type: "negative"} : negative), "negative_choice"]},
    {"name": "recur_variable_choice", "symbols": [(lexer.has("open_paren") ? {type: "open_paren"} : open_paren), "variable_choice", (lexer.has("close_paren") ? {type: "close_paren"} : close_paren), "variable_next_null"]},
    {"name": "variable", "symbols": [(lexer.has("equal") ? {type: "equal"} : equal), "recur_variable_choice"]},
    {"name": "variable", "symbols": [(lexer.has("comma") ? {type: "comma"} : comma), (lexer.has("id") ? {type: "id"} : id), "declare_choice"]},
    {"name": "recur_variable", "symbols": [(lexer.has("equal") ? {type: "equal"} : equal), "variable_choice", (lexer.has("comma") ? {type: "comma"} : comma), (lexer.has("id") ? {type: "id"} : id), "declare_choice"]},
    ...
    {"name": "struct_size", "symbols": [(lexer.has("unary_oper") ? {type: "unary_oper"} : unary_oper), (lexer.has("id") ? {type: "id"} : id), "struct_choice"]},
    ...
    {"name": "statement_choice", "symbols": [(lexer.has("unary_oper") ? {type: "unary_oper"} : unary_oper), (lexer.has("id") ? {type: "id"} : id), "assign_next_choice", (lexer.has("terminator") ? {type: "terminator"} : terminator)]},
    ...
    {"name": "assign_next_choice", "symbols": ["struct_choice"]},
    {"name": "assign_next_choice", "symbols": []},
    ...
    {"name": "function_statement_choice", "symbols": [(lexer.has("unary_oper") ? {type: "unary_oper"} : unary_oper), (lexer.has("id") ? {type: "id"} : id), "assign_next_choice", (lexer.has("terminator") ? {type: "terminator"} : terminator)]},
