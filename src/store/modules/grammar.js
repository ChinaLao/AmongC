...
var grammar = {
    ...
    {"name": "assign_choice", "symbols": ["struct_choice", "string_access", "recur_assign", (lexer.has("equal") ? {type: "equal"} : equal), "variable_choice"]},
    ...
    {"name": "choice", "symbols": []},
    {"name": "choice_less", "symbols": ["struct_new", "choice_choice_choice"]},
    {"name": "choice_less", "symbols": ["function_call_statement_choice", "choice_choice_choice"]},
    ...
    {"name": "variable_choice", "symbols": [(lexer.has("open_paren") ? {type: "open_paren"} : open_paren), "choice", (lexer.has("close_paren") ? {type: "close_paren"} : close_paren), "variable_next_null"]},
    ...
    {"name": "statement_in_function", "symbols": ["function_statement_choice"]},
    ...
    {"name": "function_loop_statement", "symbols": [(lexer.has("loopDo") ? {type: "loopDo"} : loopDo), "statement_in_function", (lexer.has("loopWhile") ? {type: "loopWhile"} : loopWhile), (lexer.has("open_paren") ? {type: "open_paren"} : open_paren), "condition", (lexer.has("close_paren") ? {type: "close_paren"} : close_paren), (lexer.has("terminator") ? {type: "terminator"} : terminator)]},
    ...
    {"name": "function_else_choice", "symbols": [(lexer.has("elf") ? {type: "elf"} : elf), (lexer.has("open_paren") ? {type: "open_paren"} : open_paren), "variable_choice", (lexer.has("close_paren") ? {type: "close_paren"} : close_paren), "statement_in_function", "else_choice"]},
    ...
    {"name": "iterate_statement_condition_less", "symbols": ["struct_choice", "iterate_unary"]},
    ...
    {"name": "function_choice", "symbols": ["struct_new", "iterate_first_choice", "choice_choice_choice"]},
    {"name": "function_choice", "symbols": ["function_call_statement_choice", "iterate_first_choice", "choice_choice_choice"]},
    {"name": "function_choice", "symbols": ["iterate_choice", "choice_choice_choice"]},
    ...
    {"name": "function_variables_choice", "symbols": ["struct_choice"]},
