...
var grammar = {
    ...
    {"name": "variable_again", "symbols": [(lexer.has("comma") ? {type: "comma"} : comma), (lexer.has("id") ? {type: "id"} : id), "variable_again"]},
    {"name": "variable_again", "symbols": []},
    {"name": "recur_choice", "symbols": ["struct_new", "iterate_first_choice", "choice_choice"]},
    {"name": "recur_choice", "symbols": ["function_call_statement_choice", "iterate_first_choice", "choice_choice"]},
    {"name": "recur_choice", "symbols": ["iterate_choice", "choice_choice"]},
    {"name": "recur_choice", "symbols": ["first_compute_choice"]},
    {"name": "recur_choice", "symbols": ["first_condition_choice"]},
    {"name": "recur_choice", "symbols": [(lexer.has("comma") ? {type: "comma"} : comma), (lexer.has("id") ? {type: "id"} : id), "variable_again"]},
    {"name": "recur_variable", "symbols": [(lexer.has("id") ? {type: "id"} : id), "recur_choice"]},
    ...
    {"name": "struct_size_choice", "symbols": ["struct_new", "iterate_unary"]},
    {"name": "struct_size_choice", "symbols": ["function_call_statement_choice", "iterate_unary"]},
