...
var grammar = {
    ...
    {"name": "choice", "symbols": []},
    {"name": "variable_choice", "symbols": ["notter", "variable_choice_choice"]},
    {"name": "variable_choice_choice", "symbols": [(lexer.has("id") ? {type: "id"} : id), "choice"]},
    {"name": "variable_choice_choice", "symbols": ["condition_less_choice_choice"]},
    ...
    {"name": "condition_less_choice_choice", "symbols": [(lexer.has("open_paren") ? {type: "open_paren"} : open_paren), "condition", (lexer.has("close_paren") ? {type: "close_paren"} : close_paren), "oper_condition"]},
