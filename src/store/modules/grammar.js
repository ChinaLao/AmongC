...
var grammar = {
    ...
    {"name": "additional_literal_2D", "symbols": [(lexer.has("comma") ? {type: "comma"} : comma), (lexer.has("open_brace") ? {type: "open_brace"} : open_brace), "literal", "additional_literal_1D", (lexer.has("close_brace") ? {type: "close_brace"} : close_brace), "additional_literal_2D"]},
    ...
    {"name": "digit_choice", "symbols": ["negation", (lexer.has("int_literal") ? {type: "int_literal"} : int_literal)]},
    {"name": "digit_choice", "symbols": ["negation", (lexer.has("dec_literal") ? {type: "dec_literal"} : dec_literal)]},
    {"name": "digit_choice", "symbols": ["negation", (lexer.has("id") ? {type: "id"} : id)]},
    ...
    {"name": "condition_choice", "symbols": ["notter", (lexer.has("id") ? {type: "id"} : id)]},
    {"name": "condition_choice", "symbols": ["notter", "compute_choice"]},
    ...
    {"name": "notter", "symbols": []},
    {"name": "enclosed_condition", "symbols": [(lexer.has("open_paren") ? {type: "open_paren"} : open_paren), "condition_choice", "additional_condition", (lexer.has("close_paren") ? {type: "close_paren"} : close_paren)]},
    {"name": "enclosed_condition", "symbols": ["condition_choice", "additional_condition"]},
    {"name": "next_condition", "symbols": ["oper_choice", "condition", "recur_condition"]},
    {"name": "next_condition", "symbols": []},
    {"name": "condition", "symbols": ["condition_choice", "next_condition"]},
    {"name": "condition", "symbols": ["notter", "enclosed_condition", "recur_condition"]},
    ...
    {"name": "additional_condition", "symbols": []},
    ...
    {"name": "iterate_choice", "symbols": ["iterate_choice", (lexer.has("int_literal") ? {type: "int_literal"} : int_literal)]},
    {"name": "iterate_choice", "symbols": ["iterate_choice", (lexer.has("dec_literal") ? {type: "dec_literal"} : dec_literal)]},
