...
var grammar = {
    ...
    {"name": "choice_choice", "symbols": ["first_compute_choice"]},
    {"name": "choice_choice", "symbols": ["first_condition_choice"]},
    ...
    {"name": "choice", "symbols": []},
    {"name": "choice_less", "symbols": ["struct_new", "choice_choice"]},
    {"name": "choice_less", "symbols": ["function_call_statement_choice", "choice_choice"]},
    {"name": "choice_less", "symbols": ["first_compute_choice"]},
    {"name": "choice_less", "symbols": ["first_condition_choice"]},
    {"name": "choice_less", "symbols": []},
    ...
    {"name": "negative_choice", "symbols": [(lexer.has("id") ? {type: "id"} : id), "choice_less"]},
    ...
    {"name": "variable_recur", "symbols": ["first_compute_choice"]},
    {"name": "variable_recur", "symbols": ["first_condition_choice"]},
    ...
    {"name": "function_statement_choice", "symbols": ["control_statement"]},
    ...
    {"name": "function_statement_choice", "symbols": [(lexer.has("singleComment") ? {type: "singleComment"} : singleComment)]},
    ...
    {"name": "digit_notter", "symbols": [(lexer.has("negative") ? {type: "negative"} : negative), (lexer.has("id") ? {type: "id"} : id), "digit_another_choice"]},
    {"name": "digit_notter", "symbols": [(lexer.has("id") ? {type: "id"} : id), "digit_another_choice"]},
    ...
    {"name": "compute_choice_less", "symbols": ["digit_notter_less", "oper_compute"]},
    ...
    {"name": "function_choice", "symbols": ["first_compute_choice"]},
    {"name": "function_choice", "symbols": ["first_condition_choice"]},
