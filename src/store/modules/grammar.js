...
var grammar = {
    ...
    {"name": "variable_choice", "symbols": ["function_call_statement"]},
    ...
    {"name": "array_choice", "symbols": ["for_choice"]},
    {"name": "array_choice", "symbols": ["iterate_statement"]},
    {"name": "array_choice", "symbols": []},
    {"name": "array_define_first", "symbols": [(lexer.has("equal") ? {type: "equal"} : equal), (lexer.has("open_brace") ? {type: "open_brace"} : open_brace), "array_choice", "additional_literal_1D", (lexer.has("close_brace") ? {type: "close_brace"} : close_brace)]},
    ...
    {"name": "array_define_second", "symbols": [(lexer.has("equal") ? {type: "equal"} : equal), (lexer.has("open_brace") ? {type: "open_brace"} : open_brace), (lexer.has("open_brace") ? {type: "open_brace"} : open_brace), "array_choice", "additional_literal_1D", (lexer.has("close_brace") ? {type: "close_brace"} : close_brace), "additional_literal_2D", (lexer.has("close_brace") ? {type: "close_brace"} : close_brace)]},
    {"name": "array_define_second", "symbols": []},
    {"name": "additional_literal_1D", "symbols": [(lexer.has("comma") ? {type: "comma"} : comma), "array_choice", "additional_literal_1D"]},
    {"name": "additional_literal_1D", "symbols": []},
    {"name": "additional_literal_2D", "symbols": [(lexer.has("comma") ? {type: "comma"} : comma), (lexer.has("open_brace") ? {type: "open_brace"} : open_brace), "array_choice", "additional_literal_1D", (lexer.has("close_brace") ? {type: "close_brace"} : close_brace), "additional_literal_2D"]},
    ...
    {"name": "in_statement", "symbols": [(lexer.has("scan") ? {type: "scan"} : scan), (lexer.has("open_paren") ? {type: "open_paren"} : open_paren), (lexer.has("id") ? {type: "id"} : id), "recur_id", (lexer.has("close_paren") ? {type: "close_paren"} : close_paren), (lexer.has("terminator") ? {type: "terminator"} : terminator)]},
    {"name": "recur_id", "symbols": ["assign_array", "id_choice", "recur_id"]},
    {"name": "recur_id", "symbols": [(lexer.has("comma") ? {type: "comma"} : comma), (lexer.has("id") ? {type: "id"} : id), "recur_id"]},
    {"name": "recur_id", "symbols": [(lexer.has("dot") ? {type: "dot"} : dot), (lexer.has("id") ? {type: "id"} : id), "recur_id"]},
    ...
    {"name": "condition_notter", "symbols": ["iterate_statement"]},
    ...
    {"name": "condition", "symbols": ["notter", (lexer.has("open_paren") ? {type: "open_paren"} : open_paren), "condition_choice", "additional_condition", (lexer.has("close_paren") ? {type: "close_paren"} : close_paren), "recur_condition"]},
    {"name": "condition", "symbols": ["condition_choice"]},
    {"name": "recur_condition", "symbols": ["additional_condition"]},
    {"name": "recur_condition", "symbols": []},
    {"name": "additional_condition", "symbols": ["oper_choice", "condition_choice", "recur_condition", "extra_condition"]},
    ...
    {"name": "for_notter", "symbols": ["negation", (lexer.has("id") ? {type: "id"} : id), (lexer.has("id_array") ? {type: "id_array"} : id_array)]},
    {"name": "for_notter", "symbols": ["literal"]},
    {"name": "for_notter", "symbols": ["function_call_statement"]},
    {"name": "for_notter", "symbols": ["struct_statement"]},
    ...
    {"name": "for_condition", "symbols": [(lexer.has("id") ? {type: "id"} : id), "oper_choice", "for_choice", "recur_for_condition", "for_condition_extra"]},
    ...
    {"name": "switch_notter", "symbols": [(lexer.has("id") ? {type: "id"} : id), "id_array"]},
    {"name": "switch_notter", "symbols": ["function_call_statement"]},
    {"name": "switch_notter", "symbols": ["struct_statement"]},
